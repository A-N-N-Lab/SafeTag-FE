    ...
    <AppContainer>
      ...
      <div>
        ...
        {disabledButtons.map((btn, i) => (
          <IconButton key={i} onClick={() => alert(`서류 제출 과정은 구현하지 못하여 바로 다음 단계로 넘어가겠습니다.`)}>
      ...
      <div>
        ...
        <IconButton onClick={() => alert(`서류 제출 과정은 구현하지 못하여 바로 다음 단계로 넘어가겠습니다.`)}>
      ...
      {stickerReissueButtons.map((btn, index) => (
          <IconButton key={index} onClick={() => alert(`서류 제출 과정은 구현하지 못하여 바로 다음 단계로 넘어가겠습니다.`)}>
          <IconImage src={btn.icon} alt={btn.title} />
          <TextContainer>
              <MainText>{btn.title}</MainText>
              <SubText>{btn.description}</SubText>
